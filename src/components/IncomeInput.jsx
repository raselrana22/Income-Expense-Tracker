...
const IncomeInput = () => {
  ...
  const totalIncome = formData.reduce((total, expense) => {
    return total + Number(expense.amount);
  }, 0);

  return (
    <div className='flex justify-between'>
      <div className='w-2/3 mx-3 my-2'>
        <div className='mt-8'>
          <div className='text-xl font-bold mb-4'>Your Incomes: </div>
            ...
            <table className='border border-black w-full'>
              ...
              <tbody>
                ...
                <div className='text-xl font-bold flex justify-center items-center'>
                  <tr>Total Income:${totalIncome}</tr>
                </div>
              </tbody>
            </table>
          ) : (
